...
#ifndef _SAME70Q20_H_
#define _SAME70Q20_H_
...
/******  SAME70Q20 specific Interrupt Numbers ***********************************/
  ...
  EFC_IRQn                  = 6  , /**< 6   SAME70Q20 Embedded Flash Controller (EFC) */
  UART0_IRQn                = 7  , /**< 7   SAME70Q20 Universal Asynchronous Receiver Transmitter (UART0) */
  UART1_IRQn                = 8  , /**< 8   SAME70Q20 Universal Asynchronous Receiver Transmitter (UART1) */
  PIOA_IRQn                 = 10 , /**< 10  SAME70Q20 Parallel Input/Output Controller (PIOA) */
  PIOB_IRQn                 = 11 , /**< 11  SAME70Q20 Parallel Input/Output Controller (PIOB) */
  PIOC_IRQn                 = 12 , /**< 12  SAME70Q20 Parallel Input/Output Controller (PIOC) */
  USART0_IRQn               = 13 , /**< 13  SAME70Q20 Universal Synchronous Asynchronous Receiver Transmitter (USART0) */
  USART1_IRQn               = 14 , /**< 14  SAME70Q20 Universal Synchronous Asynchronous Receiver Transmitter (USART1) */
  USART2_IRQn               = 15 , /**< 15  SAME70Q20 Universal Synchronous Asynchronous Receiver Transmitter (USART2) */
  PIOD_IRQn                 = 16 , /**< 16  SAME70Q20 Parallel Input/Output Controller (PIOD) */
  PIOE_IRQn                 = 17 , /**< 17  SAME70Q20 Parallel Input/Output Controller (PIOE) */
  HSMCI_IRQn                = 18 , /**< 18  SAME70Q20 High Speed MultiMedia Card Interface (HSMCI) */
  TWIHS0_IRQn               = 19 , /**< 19  SAME70Q20 Two-wire Interface High Speed (TWIHS0) */
  TWIHS1_IRQn               = 20 , /**< 20  SAME70Q20 Two-wire Interface High Speed (TWIHS1) */
  SPI0_IRQn                 = 21 , /**< 21  SAME70Q20 Serial Peripheral Interface (SPI0) */
  SSC_IRQn                  = 22 , /**< 22  SAME70Q20 Synchronous Serial Controller (SSC) */
  TC0_IRQn                  = 23 , /**< 23  SAME70Q20 Timer Counter (TC0)       */
  TC1_IRQn                  = 24 , /**< 24  SAME70Q20 Timer Counter (TC0)       */
  TC2_IRQn                  = 25 , /**< 25  SAME70Q20 Timer Counter (TC0)       */
  TC3_IRQn                  = 26 , /**< 26  SAME70Q20 Timer Counter (TC1)       */
  TC4_IRQn                  = 27 , /**< 27  SAME70Q20 Timer Counter (TC1)       */
  TC5_IRQn                  = 28 , /**< 28  SAME70Q20 Timer Counter (TC1)       */
  AFEC0_IRQn                = 29 , /**< 29  SAME70Q20 Analog Front-End Controller (AFEC0) */
  DACC_IRQn                 = 30 , /**< 30  SAME70Q20 Digital-to-Analog Converter Controller (DACC) */
  PWM0_IRQn                 = 31 , /**< 31  SAME70Q20 Pulse Width Modulation Controller (PWM0) */
  ICM_IRQn                  = 32 , /**< 32  SAME70Q20 Integrity Check Monitor (ICM) */
  ACC_IRQn                  = 33 , /**< 33  SAME70Q20 Analog Comparator Controller (ACC) */
  USBHS_IRQn                = 34 , /**< 34  SAME70Q20 USB High-Speed Interface (USBHS) */
  MCAN0_IRQn                = 35 , /**< 35  SAME70Q20 Controller Area Network (MCAN0) */
  MCAN1_IRQn                = 37 , /**< 37  SAME70Q20 Controller Area Network (MCAN1) */
  GMAC_IRQn                 = 39 , /**< 39  SAME70Q20 Gigabit Ethernet MAC (GMAC) */
  AFEC1_IRQn                = 40 , /**< 40  SAME70Q20 Analog Front-End Controller (AFEC1) */
  TWIHS2_IRQn               = 41 , /**< 41  SAME70Q20 Two-wire Interface High Speed (TWIHS2) */
  SPI1_IRQn                 = 42 , /**< 42  SAME70Q20 Serial Peripheral Interface (SPI1) */
  QSPI_IRQn                 = 43 , /**< 43  SAME70Q20 Quad Serial Peripheral Interface (QSPI) */
  UART2_IRQn                = 44 , /**< 44  SAME70Q20 Universal Asynchronous Receiver Transmitter (UART2) */
  UART3_IRQn                = 45 , /**< 45  SAME70Q20 Universal Asynchronous Receiver Transmitter (UART3) */
  UART4_IRQn                = 46 , /**< 46  SAME70Q20 Universal Asynchronous Receiver Transmitter (UART4) */
  TC6_IRQn                  = 47 , /**< 47  SAME70Q20 Timer Counter (TC2)       */
  TC7_IRQn                  = 48 , /**< 48  SAME70Q20 Timer Counter (TC2)       */
  TC8_IRQn                  = 49 , /**< 49  SAME70Q20 Timer Counter (TC2)       */
  TC9_IRQn                  = 50 , /**< 50  SAME70Q20 Timer Counter (TC3)       */
  TC10_IRQn                 = 51 , /**< 51  SAME70Q20 Timer Counter (TC3)       */
  TC11_IRQn                 = 52 , /**< 52  SAME70Q20 Timer Counter (TC3)       */
  AES_IRQn                  = 56 , /**< 56  SAME70Q20 Advanced Encryption Standard (AES) */
  TRNG_IRQn                 = 57 , /**< 57  SAME70Q20 True Random Number Generator (TRNG) */
...
typedef struct _DeviceVectors
{
  ...
  void* pfnRSTC_Handler;                         /* 1   SAME70Q20 Reset Controller (RSTC) */
  void* pfnRTC_Handler;                          /* 2   SAME70Q20 Real-time Clock (RTC) */
  void* pfnRTT_Handler;                          /* 3   SAME70Q20 Real-time Timer (RTT) */
  void* pfnWDT_Handler;                          /* 4   SAME70Q20 Watchdog Timer (WDT) */
  void* pfnPMC_Handler;                          /* 5   SAME70Q20 Power Management Controller (PMC) */
  void* pfnEFC_Handler;                          /* 6   SAME70Q20 Embedded Flash Controller (EFC) */
  void* pfnUART0_Handler;                        /* 7   SAME70Q20 Universal Asynchronous Receiver Transmitter (UART0) */
  void* pfnUART1_Handler;                        /* 8   SAME70Q20 Universal Asynchronous Receiver Transmitter (UART1) */
  void* pvReserved9;
  void* pfnPIOA_Handler;                         /* 10  SAME70Q20 Parallel Input/Output Controller (PIOA) */
  void* pfnPIOB_Handler;                         /* 11  SAME70Q20 Parallel Input/Output Controller (PIOB) */
  void* pfnPIOC_Handler;                         /* 12  SAME70Q20 Parallel Input/Output Controller (PIOC) */
  void* pfnUSART0_Handler;                       /* 13  SAME70Q20 Universal Synchronous Asynchronous Receiver Transmitter (USART0) */
  void* pfnUSART1_Handler;                       /* 14  SAME70Q20 Universal Synchronous Asynchronous Receiver Transmitter (USART1) */
  void* pfnUSART2_Handler;                       /* 15  SAME70Q20 Universal Synchronous Asynchronous Receiver Transmitter (USART2) */
  void* pfnPIOD_Handler;                         /* 16  SAME70Q20 Parallel Input/Output Controller (PIOD) */
  void* pfnPIOE_Handler;                         /* 17  SAME70Q20 Parallel Input/Output Controller (PIOE) */
  void* pfnHSMCI_Handler;                        /* 18  SAME70Q20 High Speed MultiMedia Card Interface (HSMCI) */
  void* pfnTWIHS0_Handler;                       /* 19  SAME70Q20 Two-wire Interface High Speed (TWIHS0) */
  void* pfnTWIHS1_Handler;                       /* 20  SAME70Q20 Two-wire Interface High Speed (TWIHS1) */
  void* pfnSPI0_Handler;                         /* 21  SAME70Q20 Serial Peripheral Interface (SPI0) */
  void* pfnSSC_Handler;                          /* 22  SAME70Q20 Synchronous Serial Controller (SSC) */
  void* pfnTC0_Handler;                          /* 23  SAME70Q20 Timer Counter (TC0)  */
  void* pfnTC1_Handler;                          /* 24  SAME70Q20 Timer Counter (TC0)  */
  void* pfnTC2_Handler;                          /* 25  SAME70Q20 Timer Counter (TC0)  */
  void* pfnTC3_Handler;                          /* 26  SAME70Q20 Timer Counter (TC1)  */
  void* pfnTC4_Handler;                          /* 27  SAME70Q20 Timer Counter (TC1)  */
  void* pfnTC5_Handler;                          /* 28  SAME70Q20 Timer Counter (TC1)  */
  void* pfnAFEC0_Handler;                        /* 29  SAME70Q20 Analog Front-End Controller (AFEC0) */
  void* pfnDACC_Handler;                         /* 30  SAME70Q20 Digital-to-Analog Converter Controller (DACC) */
  void* pfnPWM0_Handler;                         /* 31  SAME70Q20 Pulse Width Modulation Controller (PWM0) */
  void* pfnICM_Handler;                          /* 32  SAME70Q20 Integrity Check Monitor (ICM) */
  void* pfnACC_Handler;                          /* 33  SAME70Q20 Analog Comparator Controller (ACC) */
  void* pfnUSBHS_Handler;                        /* 34  SAME70Q20 USB High-Speed Interface (USBHS) */
  void* pfnMCAN0_Handler;                        /* 35  SAME70Q20 Controller Area Network (MCAN0) */
  void* pvReserved36;
  void* pfnMCAN1_Handler;                        /* 37  SAME70Q20 Controller Area Network (MCAN1) */
  void* pvReserved38;
  void* pfnGMAC_Handler;                         /* 39  SAME70Q20 Gigabit Ethernet MAC (GMAC) */
  void* pfnAFEC1_Handler;                        /* 40  SAME70Q20 Analog Front-End Controller (AFEC1) */
  void* pfnTWIHS2_Handler;                       /* 41  SAME70Q20 Two-wire Interface High Speed (TWIHS2) */
  void* pfnSPI1_Handler;                         /* 42  SAME70Q20 Serial Peripheral Interface (SPI1) */
  void* pfnQSPI_Handler;                         /* 43  SAME70Q20 Quad Serial Peripheral Interface (QSPI) */
  void* pfnUART2_Handler;                        /* 44  SAME70Q20 Universal Asynchronous Receiver Transmitter (UART2) */
  void* pfnUART3_Handler;                        /* 45  SAME70Q20 Universal Asynchronous Receiver Transmitter (UART3) */
  void* pfnUART4_Handler;                        /* 46  SAME70Q20 Universal Asynchronous Receiver Transmitter (UART4) */
  void* pfnTC6_Handler;                          /* 47  SAME70Q20 Timer Counter (TC2)  */
  void* pfnTC7_Handler;                          /* 48  SAME70Q20 Timer Counter (TC2)  */
  void* pfnTC8_Handler;                          /* 49  SAME70Q20 Timer Counter (TC2)  */
  void* pfnTC9_Handler;                          /* 50  SAME70Q20 Timer Counter (TC3)  */
  void* pfnTC10_Handler;                         /* 51  SAME70Q20 Timer Counter (TC3)  */
  void* pfnTC11_Handler;                         /* 52  SAME70Q20 Timer Counter (TC3)  */
  void* pvReserved53;
  void* pvReserved54;
  void* pvReserved55;
  void* pfnAES_Handler;                          /* 56  SAME70Q20 Advanced Encryption Standard (AES) */
  void* pfnTRNG_Handler;                         /* 57  SAME70Q20 True Random Number Generator (TRNG) */
...
/** @}  end of SAME70Q20_cmsis CMSIS Definitions */

/** \defgroup SAME70Q20_api Peripheral Software API
 *  @{
 */
...
/** \defgroup SAME70Q20_reg Registers Access Definitions
 *  @{
 */
...
/** \addtogroup legacy_SAME70Q20_id Legacy Peripheral Ids Definitions
 *  @{
 */

/* ************************************************************************** */
/*  LEGACY PERIPHERAL ID DEFINITIONS FOR SAME70Q20 */
/* ************************************************************************** */
...
/* ************************************************************************** */
/**  DEVICE SIGNATURES FOR SAME70Q20 */
/* ************************************************************************** */
#define JTAGID                   _UL_(0X05B3D03F)
#define CHIP_JTAGID              _UL_(0X05B3D03F)
#define CHIP_CIDR                _UL_(0XA1020C00)
