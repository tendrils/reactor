...
#define PMC_SCSR_HCLKS_Msk                  (_U_(0x1) << PMC_SCSR_HCLKS_Pos)               /**< (PMC_SCSR) Processor Clock Status Mask */
...
#define CKGR_MOR_MOSCXTEN_Msk               (_U_(0x1) << CKGR_MOR_MOSCXTEN_Pos)            /**< (CKGR_MOR) 3 to 20 MHz Crystal Oscillator Enable Mask */
...
#define CKGR_MOR_MOSCXTBY_Msk               (_U_(0x1) << CKGR_MOR_MOSCXTBY_Pos)            /**< (CKGR_MOR) 3 to 20 MHz Crystal Oscillator Bypass Mask */
...
#define CKGR_MOR_MOSCRCEN_Msk               (_U_(0x1) << CKGR_MOR_MOSCRCEN_Pos)            /**< (CKGR_MOR) 4/8/12 MHz On-Chip RC Oscillator Enable Mask */
...
#define CKGR_MOR_MOSCRCF_Msk                (_U_(0x7) << CKGR_MOR_MOSCRCF_Pos)             /**< (CKGR_MOR) 4/8/12 MHz RC Oscillator Frequency Selection Mask */
#define CKGR_MOR_MOSCRCF(value)             (CKGR_MOR_MOSCRCF_Msk & ((value) << CKGR_MOR_MOSCRCF_Pos))
#define   CKGR_MOR_MOSCRCF_4_MHz_Val        _U_(0x0)                                       /**< (CKGR_MOR) The RC oscillator frequency is at 4 MHz (default)  */
...
#define CKGR_MOR_MOSCXTST_Msk               (_U_(0xFF) << CKGR_MOR_MOSCXTST_Pos)           /**< (CKGR_MOR) 3 to 20 MHz Crystal Oscillator Start-up Time Mask */
...
#define PMC_MCKR_UPLLDIV2_Msk               (_U_(0x1) << PMC_MCKR_UPLLDIV2_Pos)            /**< (PMC_MCKR) UPLL Divisor by 2 Mask */
...
#define   PMC_PCK_CSS_UPLL_CLK_Val          _U_(0x3)                                       /**< (PMC_PCK) Divided UPLL Clock is selected  */
...
#define PMC_IER_MOSCXTS_Msk                 (_U_(0x1) << PMC_IER_MOSCXTS_Pos)              /**< (PMC_IER) 3 to 20 MHz Crystal Oscillator Status Interrupt Enable Mask */
...
#define PMC_IER_MOSCRCS_Msk                 (_U_(0x1) << PMC_IER_MOSCRCS_Pos)              /**< (PMC_IER) 4/8/12 MHz RC Oscillator Status Interrupt Enable Mask */
...
#define PMC_IER_MASK                        _U_(0x27074B)                                  /**< \deprecated (PMC_IER) Register MASK  (Use PMC_IER_Msk instead)  */
#define PMC_IER_Msk                         _U_(0x27074B)                                  /**< (PMC_IER) Register Mask  */
...
#define PMC_IDR_MOSCXTS_Msk                 (_U_(0x1) << PMC_IDR_MOSCXTS_Pos)              /**< (PMC_IDR) 3 to 20 MHz Crystal Oscillator Status Interrupt Disable Mask */
...
#define PMC_IDR_MOSCRCS_Msk                 (_U_(0x1) << PMC_IDR_MOSCRCS_Pos)              /**< (PMC_IDR) 4/8/12 MHz RC Status Interrupt Disable Mask */
...
#define PMC_IDR_MASK                        _U_(0x27074B)                                  /**< \deprecated (PMC_IDR) Register MASK  (Use PMC_IDR_Msk instead)  */
#define PMC_IDR_Msk                         _U_(0x27074B)                                  /**< (PMC_IDR) Register Mask  */
...
#define PMC_SR_MOSCXTS_Msk                  (_U_(0x1) << PMC_SR_MOSCXTS_Pos)               /**< (PMC_SR) 3 to 20 MHz Crystal Oscillator Status Mask */
...
#define PMC_SR_MOSCRCS_Msk                  (_U_(0x1) << PMC_SR_MOSCRCS_Pos)               /**< (PMC_SR) 4/8/12 MHz RC Oscillator Status Mask */
...
#define PMC_SR_MASK                         _U_(0x3F07CB)                                  /**< \deprecated (PMC_SR) Register MASK  (Use PMC_SR_Msk instead)  */
#define PMC_SR_Msk                          _U_(0x3F07CB)                                  /**< (PMC_SR) Register Mask  */
...
#define PMC_IMR_MOSCXTS_Msk                 (_U_(0x1) << PMC_IMR_MOSCXTS_Pos)              /**< (PMC_IMR) 3 to 20 MHz Crystal Oscillator Status Interrupt Mask Mask */
...
#define PMC_IMR_MOSCRCS_Msk                 (_U_(0x1) << PMC_IMR_MOSCRCS_Pos)              /**< (PMC_IMR) 4/8/12 MHz RC Status Interrupt Mask Mask */
...
#define PMC_IMR_MASK                        _U_(0x27074B)                                  /**< \deprecated (PMC_IMR) Register MASK  (Use PMC_IMR_Msk instead)  */
#define PMC_IMR_Msk                         _U_(0x27074B)                                  /**< (PMC_IMR) Register Mask  */
...
#define PMC_OCR_CAL4_Msk                    (_U_(0x7F) << PMC_OCR_CAL4_Pos)                /**< (PMC_OCR) RC Oscillator Calibration bits for 4 MHz Mask */
...
#define PMC_OCR_SEL4_Msk                    (_U_(0x1) << PMC_OCR_SEL4_Pos)                 /**< (PMC_OCR) Selection of RC Oscillator Calibration bits for 4 MHz Mask */
...
#define PMC_OCR_CAL12_Msk                   (_U_(0x7F) << PMC_OCR_CAL12_Pos)               /**< (PMC_OCR) RC Oscillator Calibration bits for 12 MHz Mask */
...
#define PMC_OCR_SEL12_Msk                   (_U_(0x1) << PMC_OCR_SEL12_Pos)                /**< (PMC_OCR) Selection of RC Oscillator Calibration bits for 12 MHz Mask */
