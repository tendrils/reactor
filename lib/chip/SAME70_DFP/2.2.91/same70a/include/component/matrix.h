...
#define MATRIX_MRCR_MASK                    _U_(0xF7F)                                     /**< \deprecated (MATRIX_MRCR) Register MASK  (Use MATRIX_MRCR_Msk instead)  */
#define MATRIX_MRCR_Msk                     _U_(0xF7F)                                     /**< (MATRIX_MRCR) Register Mask  */
