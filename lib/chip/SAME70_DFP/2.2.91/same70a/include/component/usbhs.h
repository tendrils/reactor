...
#define USBHS_DEVEPT_MASK                   _U_(0x1FF01FF)                                 /**< \deprecated (USBHS_DEVEPT) Register MASK  (Use USBHS_DEVEPT_Msk instead)  */
#define USBHS_DEVEPT_Msk                    _U_(0x1FF01FF)                                 /**< (USBHS_DEVEPT) Register Mask  */

#define USBHS_DEVEPT_EPEN_Pos               0                                              /**< (USBHS_DEVEPT Position) Endpoint x Enable */
#define USBHS_DEVEPT_EPEN_Msk               (_U_(0x1FF) << USBHS_DEVEPT_EPEN_Pos)          /**< (USBHS_DEVEPT Mask) EPEN */
...
#define USBHS_DEVEPT_EPRST_Msk              (_U_(0x1FF) << USBHS_DEVEPT_EPRST_Pos)         /**< (USBHS_DEVEPT Mask) EPRST */
...
#define USBHS_SR_VBUSRQ_Msk                 (_U_(0x1) << USBHS_SR_VBUSRQ_Pos)              /**< (USBHS_SR) VBUS Request (Host mode only) Mask */
...
#define USBHS_SR_MASK                       _U_(0x7210)                                    /**< \deprecated (USBHS_SR) Register MASK  (Use USBHS_SR_Msk instead)  */
#define USBHS_SR_Msk                        _U_(0x7210)                                    /**< (USBHS_SR) Register Mask  */
...
#define USBHS_SCR_VBUSRQC_Msk               (_U_(0x1) << USBHS_SCR_VBUSRQC_Pos)            /**< (USBHS_SCR) VBUS Request Clear Mask */
...
#define USBHS_SCR_MASK                      _U_(0x210)                                     /**< \deprecated (USBHS_SCR) Register MASK  (Use USBHS_SCR_Msk instead)  */
#define USBHS_SCR_Msk                       _U_(0x210)                                     /**< (USBHS_SCR) Register Mask  */
