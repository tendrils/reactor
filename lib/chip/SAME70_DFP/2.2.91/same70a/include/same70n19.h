...
/******  SAME70N19 specific Interrupt Numbers ***********************************/
  ...
  EFC_IRQn                  = 6  , /**< 6   SAME70N19 Embedded Flash Controller (EFC) */
  UART0_IRQn                = 7  , /**< 7   SAME70N19 Universal Asynchronous Receiver Transmitter (UART0) */
  UART1_IRQn                = 8  , /**< 8   SAME70N19 Universal Asynchronous Receiver Transmitter (UART1) */
  PIOA_IRQn                 = 10 , /**< 10  SAME70N19 Parallel Input/Output Controller (PIOA) */
  PIOB_IRQn                 = 11 , /**< 11  SAME70N19 Parallel Input/Output Controller (PIOB) */
  USART0_IRQn               = 13 , /**< 13  SAME70N19 Universal Synchronous Asynchronous Receiver Transmitter (USART0) */
  USART1_IRQn               = 14 , /**< 14  SAME70N19 Universal Synchronous Asynchronous Receiver Transmitter (USART1) */
  USART2_IRQn               = 15 , /**< 15  SAME70N19 Universal Synchronous Asynchronous Receiver Transmitter (USART2) */
  PIOD_IRQn                 = 16 , /**< 16  SAME70N19 Parallel Input/Output Controller (PIOD) */
  HSMCI_IRQn                = 18 , /**< 18  SAME70N19 High Speed MultiMedia Card Interface (HSMCI) */
  TWIHS0_IRQn               = 19 , /**< 19  SAME70N19 Two-wire Interface High Speed (TWIHS0) */
  TWIHS1_IRQn               = 20 , /**< 20  SAME70N19 Two-wire Interface High Speed (TWIHS1) */
  SPI0_IRQn                 = 21 , /**< 21  SAME70N19 Serial Peripheral Interface (SPI0) */
  ...
  AES_IRQn                  = 56 , /**< 56  SAME70N19 Advanced Encryption Standard (AES) */
  TRNG_IRQn                 = 57 , /**< 57  SAME70N19 True Random Number Generator (TRNG) */
...
typedef struct _DeviceVectors
{
  ...
  void* pfnRSTC_Handler;                         /* 1   SAME70N19 Reset Controller (RSTC) */
  void* pfnRTC_Handler;                          /* 2   SAME70N19 Real-time Clock (RTC) */
  void* pfnRTT_Handler;                          /* 3   SAME70N19 Real-time Timer (RTT) */
  void* pfnWDT_Handler;                          /* 4   SAME70N19 Watchdog Timer (WDT) */
  void* pfnPMC_Handler;                          /* 5   SAME70N19 Power Management Controller (PMC) */
  void* pfnEFC_Handler;                          /* 6   SAME70N19 Embedded Flash Controller (EFC) */
  void* pfnUART0_Handler;                        /* 7   SAME70N19 Universal Asynchronous Receiver Transmitter (UART0) */
  void* pfnUART1_Handler;                        /* 8   SAME70N19 Universal Asynchronous Receiver Transmitter (UART1) */
  void* pvReserved9;
  void* pfnPIOA_Handler;                         /* 10  SAME70N19 Parallel Input/Output Controller (PIOA) */
  void* pfnPIOB_Handler;                         /* 11  SAME70N19 Parallel Input/Output Controller (PIOB) */
  void* pvReserved12;
  void* pfnUSART0_Handler;                       /* 13  SAME70N19 Universal Synchronous Asynchronous Receiver Transmitter (USART0) */
  void* pfnUSART1_Handler;                       /* 14  SAME70N19 Universal Synchronous Asynchronous Receiver Transmitter (USART1) */
  void* pfnUSART2_Handler;                       /* 15  SAME70N19 Universal Synchronous Asynchronous Receiver Transmitter (USART2) */
  void* pfnPIOD_Handler;                         /* 16  SAME70N19 Parallel Input/Output Controller (PIOD) */
  void* pvReserved17;
  void* pfnHSMCI_Handler;                        /* 18  SAME70N19 High Speed MultiMedia Card Interface (HSMCI) */
  void* pfnTWIHS0_Handler;                       /* 19  SAME70N19 Two-wire Interface High Speed (TWIHS0) */
  void* pfnTWIHS1_Handler;                       /* 20  SAME70N19 Two-wire Interface High Speed (TWIHS1) */
  void* pfnSPI0_Handler;                         /* 21  SAME70N19 Serial Peripheral Interface (SPI0) */
  void* pfnSSC_Handler;                          /* 22  SAME70N19 Synchronous Serial Controller (SSC) */
  ...
  void* pvReserved54;
  void* pvReserved55;
  void* pfnAES_Handler;                          /* 56  SAME70N19 Advanced Encryption Standard (AES) */
  void* pfnTRNG_Handler;                         /* 57  SAME70N19 True Random Number Generator (TRNG) */
...
/** @}  end of SAME70N19_cmsis CMSIS Definitions */

/** \defgroup SAME70N19_api Peripheral Software API
 *  @{
 */
...
/** \defgroup SAME70N19_reg Registers Access Definitions
 *  @{
 */
...
/** \addtogroup legacy_SAME70N19_id Legacy Peripheral Ids Definitions
 *  @{
 */

/* ************************************************************************** */
/*  LEGACY PERIPHERAL ID DEFINITIONS FOR SAME70N19 */
/* ************************************************************************** */
